        ...
        <nav className="bg-gray-800">
            ...
            {menuOpen && <div className="sm:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1">
                    <NavbarButton text={'Dashboard'} active={true} dropdown={true}/>
                    <NavbarButton text={'Team'} active={false} dropdown={true}/>
                    <NavbarButton text={'Projects'} active={false} dropdown={true}/>
                    <NavbarButton text={'Calendar'} active={false} dropdown={true}/>
                </div>
            </div>}
        </nav>
    )
